...
* `server` (Object|Function|`false`)
  - If an object is supplied: used as options to create a dev server. Passed to [BrowserDriver.startServer](/docs/modules/test-utils/browser-driver).
...
* `browser` (Object) - options used to create the Puppeteer instance. Passed to [BrowserDriver.startBrowser](/docs/modules/test-utils/browser-driver).
